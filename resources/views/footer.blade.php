<footer class="font-sans tracking-wide bg-[#213343] py-10 px-10">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
            ...
            <ul class="space-y-5">
                <li>
                    <a href="javascript:void(0)" class="hover:text-[#FFA726] text-gray-300 text-[15px] transition-all">Our
                        Story</a>
                </li>
                <li>
        ...
        <div>
            ...
            <ul class="space-y-5">
                ...
                <li>
                    <a href="javascript:void(0)"
                        class="hover:text-[#FFA726] text-gray-300 text-[15px] transition-all">Mobile App Development</a>
                </li>
            </ul>
        </div>
